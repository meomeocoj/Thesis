...
const { TorusStorageLayer } = require("@oraichain/storage-layer-torus");
const { encrypt, getPubKeyECC } = require("@oraichain/common-types");
...
describe("API-calls", function () {
  describe("/default", function () {
    it("it should return a welcome message", async function () {
      ...
      assert.strictEqual(res.text, "Welcome to Social Login Metadata");
    });
